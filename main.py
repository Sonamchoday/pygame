...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_life, yellow_life):
    WIN.blit(SPACE, (0, 0))
    pygame.draw.rect(WIN, BLACK, BORDER )

    red_life_text = LIFE_FONT.render("Life:" + str(red_life), 1, WHITE)
    yellow_life_text = LIFE_FONT.render("Life:" + str(yellow_life), 1, WHITE)
...
def main():
    ...
    while run:
        ...
        draw_window(red, yellow, red_bullets, yellow_bullets, red_life, yellow_life)
